        ...
        > 
            <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    /> 
                    <span style={{ color: 'white', fontSize: '24px', fontWeight: '600' }}>Service Manager Dashboard</span>
                </div>

                {/* Navigation Links */}
                <nav style={{ display: 'flex', gap: '24px' }}> {/* space-x-6 */}
                    
                    <a href="/day-out-packages" style={navLinkStyle}>Day-out Packages</a>
                    <a href="/spa-services" style={navLinkStyle}>Spa Services</a>
                    <a href="/activitiesD" style={navLinkStyle}>Activities</a>
                    <a href="/report" style={navLinkStyle}>Generate Report</a>
                </nav>
