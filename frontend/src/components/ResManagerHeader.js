        ...
        > 
            <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    /> 
                    <span style={{ color: 'white', fontSize: '24px', fontWeight: '600' }}>Reservation Manager Dashboard</span>
                </div>

                {/* Navigation Links */}
                <nav style={{ display: 'flex', gap: '24px' }}> {/* space-x-6 */}
                    <a href="/getbookings" style={navLinkStyle}>Reservations</a>
                    <a href="/getrooms" style={navLinkStyle}>Rooms</a>
...
export default ResManagerHeader;
